...
public class Pedido {
	...
	public Pedido(int idPedido, Cliente cliente, Entregador entregador, Date data, Date horaPedido, Date horaEntrega, Date horaFim) {
	...
	public Pedido(String idPedido, String idCliente, String idEntregador, String data, String horaPedido, String horaEntrega, String horaFim) {
		this.idPedido = Integer.valueOf(idPedido);
		...
		try {
			...
			System.out.println("Erro ao converter data/hora: " + e);
		}
